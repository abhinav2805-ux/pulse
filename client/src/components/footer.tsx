        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="hover:text-blue-400 transition-colors duration-300" target='_blank'>
              ...
              <a href="https://github.com/AnshJain9159/pulse" target='_blank' className="hover:text-blue-400 transition-colors duration-300">
                <svg className="h-6 w-6 fill-current" viewBox="0 0 24 24">
